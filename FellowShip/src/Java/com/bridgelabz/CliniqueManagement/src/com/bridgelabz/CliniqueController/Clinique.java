package com.bridgelabz.CliniqueController;
...
import com.bridgelabz.CliniqueService.CliniqueImplement;

public class Clinique {
	public static void main(String[] args)
			throws JarException, JSONException, IOException, InterruptedException {
	...
	CliniqueImplement service = new CliniqueImplement();
