...
import com.bridgelabz.CliniqueModel.Appointment;
import com.bridgelabz.CliniqueModel.Availability;
import com.bridgelabz.CliniqueModel.Doctor;
import com.bridgelabz.CliniqueModel.DoctorModel;
import com.bridgelabz.CliniqueModel.Patient;
import com.bridgelabz.CliniqueModel.PatientModel;
...
public class CliniqueImplement implements Clinique {
	// instantiation
		...
		private Appointment modelAppointment = new Appointment();
		...
		public void readJson() {
			...
			if (fileAppointment.exists() && fileAppointment.length() > 0) {
				try {
					modelAppointment = (Appointment) JsonUtil.readMapper(pathAppointmentJson, modelAppointment);
				} catch (IOException e) {
					e.printStackTrace();
				}
